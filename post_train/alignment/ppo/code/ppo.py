...
def main() -> None:
    ...
    train_config = {
        "stage": "ppo",
        "do_train": True,
        "model_name_or_path": PPO_CONFIG["model_id"],
        "reward_model": PPO_CONFIG["reward_model"],
        "reward_model_type": PPO_CONFIG["reward_model_type"],
        "dataset": PPO_CONFIG["dataset"],
        "template": PPO_CONFIG["template"],
        "finetuning_type": "lora",
        "lora_target": "all",
        "output_dir": str(checkpoints_dir),
        "overwrite_output_dir": True,
        "save_only_model": True,
        "per_device_train_batch_size": PPO_CONFIG["batch_size"],
        "gradient_accumulation_steps": PPO_CONFIG["grad_accum"],
        "lr_scheduler_type": "cosine",
        "logging_steps": PPO_CONFIG["logging_steps"],
        "save_steps": PPO_CONFIG["save_steps"],
        "learning_rate": PPO_CONFIG["learning_rate"],
        "num_train_epochs": PPO_CONFIG["num_train_epochs"],
        "max_samples": PPO_CONFIG["max_samples"],
        "max_grad_norm": 1.0,
        "report_to": "none",
        "ppo_buffer_size": PPO_CONFIG["ppo_buffer_size"],
        "ppo_epochs": PPO_CONFIG["ppo_epochs"],
        "ppo_target": PPO_CONFIG["ppo_target"],
        "ppo_score_norm": PPO_CONFIG["ppo_score_norm"],
        "ppo_whiten_rewards": PPO_CONFIG["ppo_whiten_rewards"],
        "bf16": runtime["bf16"],
        "fp16": runtime["fp16"],
    }
